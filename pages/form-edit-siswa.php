<?php
    if (isset($_GET['nomer'])) {
        ...
        $query="SELECT * FROM `tb_siswa` WHERE nomer='$nomer'";
          ...
          <div class="row g-0">
            ...
            <div class="col-xl-6">
              <div class="card-body p-md-5 text-black">
                <h3 class="mb-5 text-uppercase">Update Data Siswa</h3>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <input type="text" name="kelas" class="form-control form-control-lg"  value="<?php echo $data['kelas'];?>"  />
                      <label class="form-label" for="form3Example1n1">Kelas</label>
                    </div>
                  </div>
                </div>
