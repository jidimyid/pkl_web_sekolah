      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7 py-5">
            <h3>Tambah Siswa</h3>
            <p class="mb-4">Tambahkan data siswa melalui form dibawah ini!</p>
            <form action="tambah-siswa.php" method="post">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group first">
                    <label for="nama">Nama Siswa</label>
                    <input type="text" class="form-control" placeholder="Arya Putra" name="nama">
                  </div>    
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group first">
                    ...
                    <input type="text" class="form-control" placeholder="Bareng Kartini" name="alamat">
                  </div>    
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group first">
                    ...
                    <input type="text" class="form-control" placeholder="XI RPL B" name="kelas">
                  </div>    
                </div>
              </div>
              ...
              <div class="d-flex mb-5 mt-4 align-items-center">
                ...
                <label class="control control--checkbox mb-0"><span class="caption">Atau ingin mengelola <a href="siswa-edit.php">data siswa?</a>.</span>
                </label>
              </div>
              </div>
